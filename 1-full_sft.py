...
def init_data(args, lm_config, tokenizer, accelerator):
    ...
    train_ds = SFTDataset(data_paths, tokenizer, max_length=lm_config.max_seq_len)
...
# accelerate launch --multi_gpu --num_processes 8 --main_process_port ${PORTS[0]} 1-full_sft.py --use_wandb
