...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_dir", type=str, default="./out/full_sft/", help="Path to loading model")
    parser.add_argument("--save_dir", type=str, default="./out/dpo_train/", help="Path to saving model")
